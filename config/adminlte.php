...
return [
    ...
    */
     ...
     * ----------------------------------------- */
        ...
        //             'icon'   => 'fas fa-boxes',
        //             'active' => ['admin/inventory', 'admin/inventory/*'],
        //         ],
        ...
        //             'active' => ['admin/inventory/transfers*'],
        //         ],
        ...
        //             'route' => 'admin.reports.stock-level',
        //             'icon'  => 'fas fa-box-open',
        //             'active' => ['admin/reports/stock-level*'],
        //         ],
        ...
        //             'icon'  => 'fas fa-random',
        //             'active' => ['admin/reports/stock-movement*'],
        //         ],

        //         [
        //             'text'  => 'Stock Transfer Report',
        //             'route' => 'admin.reports.stock-transfers',
        //             'icon'  => 'fas fa-exchange-alt',
        //             'active' => ['admin/reports/stock-transfers*'],
        //         ]
        //   ]
        //
    ],
        ...
        'Datatables' => [
            ...
            'files' => [
                ...
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'css/admin-custom.css', // public/css/admin-custom.css
                ],
            ],
        ],
        'Select2' => [
